...
<div class="content-area">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-4">
            <select id="timeRange" class="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                <option value="7">Son 7 Gün</option>
                <option value="30">Son 30 Gün</option>
                <option value="90">Son 90 Gün</option>
                <option value="365">Son 1 Yıl</option>
            </select>
            <button onclick="exportAnalytics()" class="bg-primary-500 text-white px-4 py-2 rounded-lg hover:bg-primary-600 transition-colors">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="stat-card">
            <div class="flex flex-col items-center mb-3 w-full">
                <div class="card-icon bg-blue-100 mb-2">
                    <i class="fas fa-users text-blue-500 text-xl"></i>
                </div>
                <h3 class="card-title text-lg font-semibold text-gray-900 text-center">Toplam Öğretmen</h3>
            </div>
            <p class="text-3xl font-bold text-blue-500 text-center"><?php echo $viewModel->getTotalTeachers(null); ?></p>
        </div>
        
        <div class="stat-card">
            <div class="flex flex-col items-center mb-3 w-full">
                <div class="card-icon bg-green-100 mb-2">
                    <i class="fas fa-file-alt text-green-500 text-xl"></i>
                </div>
                <h3 class="card-title text-lg font-semibold text-gray-900 text-center">Aktif Başvurular</h3>
            </div>
            <p class="text-3xl font-bold text-green-500 text-center"><?php echo $viewModel->getActiveApplications(); ?></p>
                    </div>

        <div class="stat-card">
            <div class="flex flex-col items-center mb-3 w-full">
                <div class="card-icon bg-yellow-100 mb-2">
                    <i class="fas fa-clock text-yellow-500 text-xl"></i>
                </div>
                <h3 class="card-title text-lg font-semibold text-gray-900 text-center">Bekleyen Başvurular</h3>
            </div>
            <p class="text-3xl font-bold text-yellow-500 text-center"><?php echo $viewModel->getPendingApplications(); ?></p>
        </div>
        
        <div class="stat-card">
            <div class="flex flex-col items-center mb-3 w-full">
                <div class="card-icon bg-red-100 mb-2">
                    <i class="fas fa-times-circle text-red-500 text-xl"></i>
                </div>
                <h3 class="card-title text-lg font-semibold text-gray-900 text-center">Reddedilen Başvurular</h3>
            </div>
            <p class="text-3xl font-bold text-red-500 text-center"><?php echo $viewModel->getRejectedApplications(); ?></p>
        </div>
        
        <div class="stat-card">
            <div class="flex flex-col items-center mb-3 w-full">
                <div class="card-icon bg-purple-100 mb-2">
                    <i class="fas fa-check-circle text-purple-500 text-xl"></i>
                </div>
                <h3 class="card-title text-lg font-semibold text-gray-900 text-center">Onaylanan Başvurular</h3>
            </div>
            <p class="text-3xl font-bold text-purple-500 text-center"><?php echo $viewModel->getApprovedApplications(); ?></p>
        </div>
    </div>
